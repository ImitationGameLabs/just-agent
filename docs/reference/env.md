...
| Variable             | Required | Default                              | Description                                                                                                                                                                                                                                                                                                                                                                        |
| -------------------- | -------- | ------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| (data root)           | —        | —                                    | Derived from `KALLIP_TAGMA_SLUG` under the platform data dir (see the Local daemon section); there is no per-instance data-dir variable to set. The runtime writes `agents/`, `archived/`, and `skills/` directly under it.                                                                                                                                                                                                                                    |
