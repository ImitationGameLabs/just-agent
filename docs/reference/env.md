...
| Variable                    | Required | Default                    | Description                                                                                                                                                                                                                                       |
| --------------------------- | -------- | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `KALLIP_TAGMA_ADDR`         | no       | `127.0.0.1:3000`           | Listen address for the tagma HTTP server. Set to `0.0.0.0:3000` for container deployments.                                                                                                                                                        |
...
| Variable             | Required | Default                              | Description                                                                                                                                                                                                                                                                                                                                                                        |
| -------------------- | -------- | ------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `KALLIP_DATA_DIR`    | no       | Platform data dir (`~/.local/share`) | The tagma's data directory, used verbatim. The runtime writes `agents/`, `archived/` (removed agents), and `skills/` directly under it. When unset, it defaults to the fixed standalone instance tree `~/.local/share/kallipai/tagmata/default/`; daemon-managed instances get `~/.local/share/kallipai/tagmata/<slug>/` (the daemon sets the env itself).                                                                             |
...
| Variable                  | Required | Default                         | Description                                                                                                                                                                                             |
| ------------------------- | -------- | ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `KALLIP_DAEMON_DATA_DIR`  | no       | `~/.local/share/kallipai/tagmata/` | The daemon's instance-tree root (one `<slug>/` child per instance), used verbatim. The standalone runtime's own default is the fixed `default/` leaf under the same root.                                |
| `KALLIP_STATE_DIR`        | no       | `~/.local/state/kallipai/daemon/` | Daemon-owned state directory; the control socket lives at `STATE_DIR/control.sock`. The socket path itself can be overridden directly via `KALLIP_DAEMON_SOCKET`. Private to the daemon.                |
