...
| Variable             | Required | Default                              | Description                                                                                                                                                                                                                                                                                                                                                                        |
| -------------------- | -------- | ------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `KALLIP_DATA_DIR`    | no       | Platform data dir (`~/.local/share`) | The tagma's data directory, used verbatim. The runtime writes `agents/`, `archived/` (removed agents), and `skills/` directly under it. When unset, it defaults to the namespaced platform dir `~/.local/share/kallip/`.                                                                                                                                                           |
