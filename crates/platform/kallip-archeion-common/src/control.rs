...
//! tagma). These are the request/response bodies for the archeion's enroll route;
//! the archeion records the pinned device key and requires a signed proof of
...
pub struct EnrollRequest {
    ...
    pub code: String,
    /// The tagma's pinned Ed25519 device public key. The archeion records this and
    ...
    /// archeion verifies this before consuming the code, so a stolen enrollment
...
pub struct EnrollResponse {
    ...
    /// its tunnel. Stored at rest only as a SHA-256 hash by the archeion.
