...
//!
//! All request/response DTOs live in `kallip_archeion_common::admin` so the
//! `kallip-archeion-client` (admin CLI) shares one wire contract with the server.
